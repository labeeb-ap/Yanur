...
class POSConfig(models.Model):
    ...
    iface_validate_global_discount = fields.Boolean(string='Enable Validation for Global Discount',
                                                    help=('Enabling this will allow manager to validate'
                                                          ' the order if global discount is applicable'))

    # iface_validate_cash_control = fields.Boolean(string='Enable Validation for Cash Control',
    #                                              help=('Enabling this will allow Control the cash flow in counter'))
