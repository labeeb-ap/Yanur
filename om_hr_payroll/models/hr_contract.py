...
class HrContract(models.Model):
    ...
    hra = fields.Monetary(string='Basic', help="House rent allowance.")
    travel_allowance = fields.Monetary(string="Vehicle Allowance", help="Travel allowance")
    da = fields.Monetary(string="Allowance", help="Dearness allowance")
    meal_allowance = fields.Monetary(string="Food Allowance", help="Meal allowance")
