...
odoo.define('pos_orders_all.models', function(require) {
	...
	models.load_models({
		...
		fields: ['name','apply_coupon_on', 'c_barcode', 'user_id', 'issue_date','is_sold', 'expiry_date', 'partner_id', 'order_ids', 'active', 'amount', 'description','used','coupon_count', 'coupon_apply_times','expiry_date','partner_true','partner_id'],
		domain: null,
