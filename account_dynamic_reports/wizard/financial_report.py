...
class InsFinancialReport(models.TransientModel):
    ...
    company_name = fields.Char(
        related='company_id.name', string='Company Name', store=True
