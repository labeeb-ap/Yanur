...
class CashAccountReportAllWizard(models.TransientModel):
    _name = "cash.account.report.all.wizard"
    _description = "General Cash Account Report"
    ...
    def action_print_report(self):
        ...
        action = self.env.ref('cash_ac_report.cash_account_report_all_pdf').report_action(self, data=data)
    ...
    def print_xl_report(self):
        ...
        return {
            ...
            'data': {'model': 'cash.account.report.all.wizard',
    ...
    def get_xlsx_report(self, data, response):
        ...
        sheet.merge_range('A3:H3', 'General Ledger Report', size)
